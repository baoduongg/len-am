        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-2 group">
              <span className="text-2xl font-serif font-bold text-accent tracking-tight transition-transform duration-300 group-hover:scale-102">
                Len Ấm
              </span>
            </Link>
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between pb-4 border-b border-border-custom/50 mb-6">
                <span className="font-serif text-lg font-bold text-ink">Giỏ hàng của bạn</span>
                <button
                  onClick={() => setIsCartOpen(false)}
